...
export const SEED_CUSTOMERS: Customer[] = [
  {
    ...
    city: 'Chicago',
    country: 'USA',
    notes: 'Key enterprise account requiring expedited freight delivery on all orders.',
    status: 'active',
  ...
  },
  {
    ...
    company_name: 'Vanguard Freight & Logistics',
    contact_person: 'Brenda Holloway',
    phone: '+1 (555) 876-5432',
    email: 'b.holloway@vanguardfl.com',
    address: '450 Terminal Way',
    city: 'Houston',
    country: 'USA',
    notes: 'Logistics fulfillment partner with recurring pallet wrapping orders.',
    status: 'active',
  ...
  },
  {
    ...
    contact_person: 'Dr. David Chen',
    phone: '+1 (555) 345-6789',
    email: 'd.chen@horizonhealth.org',
    address: '780 Medical Center Blvd',
    city: 'Boston',
    country: 'USA',
    notes: 'Medical distribution account with sterile packaging compliance requirements.',
    status: 'active',
  ...
  },
  {
    ...
    company_name: 'Summit Retail Distributors',
    contact_person: 'Rachel Adams',
    phone: '+1 (555) 901-2345',
    email: 'radams@summitretail.com',
    address: '120 Commerce Way',
    city: 'Atlanta',
    country: 'USA',
    notes: 'Regional retail network buying bulk cleaning & packaging supplies.',
    status: 'active',
  ...
  },
  {
    ...
    company_name: 'Pacific Rim Manufacturing',
    contact_person: 'Kenji Sato',
    phone: '+1 (555) 678-9012',
    email: 'ksato@pacificrimmfg.com',
    address: '890 Logistics Hwy',
    city: 'Seattle',
    country: 'USA',
    notes: 'Heavy machinery manufacturer purchasing solvent degreasers and PPE.',
    status: 'active',
  ...
  },
  {
    ...
    company_name: 'Legacy Construction Corp',
    contact_person: 'Tom Sterling',
    phone: '+1 (555) 432-1098',
    email: 'tsterling@legacyconst.com',
    address: '34 Builders Square',
    city: 'Denver',
    country: 'USA',
    notes: 'Account deactivated due to merger.',
    status: 'inactive',
